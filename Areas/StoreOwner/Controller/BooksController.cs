...
using NTL_Book.Areas.StoreOwner.ViewModel;
using NTL_Book.Data;
...
public class BooksController : Microsoft.AspNetCore.Mvc.Controller
{
    ...
    public BooksController(NTL_BookDbContext context, UserManager<ApplicationUser> userManager)
    {
        _context = context;
        this.userManager = userManager;
    }

    public async Task<IActionResult> IndexBookStoreOwners()
    {
    ...
    public async Task<IActionResult> DetailBookStoreOwners(int? id)
    {
    ...
    // GET: Books/Create
    public IActionResult CreateBookStoreOwners()
    {
    ...
    public async Task<IActionResult> CreateBookStoreOwners(BookCreate model)
    {
    ...
    public async Task<IActionResult> EditBookStoreOwner(int? id)
    {
        if (id == null || _context.Books == null)
        {
            return NotFound();
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> EditBookStoreOwner(int id, Book book)
    {
        if (id != book.Id)
        {
            return NotFound();
    ...
    // GET: Books/Delete/5
    public async Task<IActionResult> DeleteBookStoreOwner(int? id)
    {
        if (id == null || _context.Books == null)
        {
            return NotFound();
