...
using NTL_Book.Areas.Admin.ViewModel;
using NTL_Book.Data;
using NTL_Book.Helpers;
using NTL_Book.Models;

namespace NTL_Book.Areas.Admin.Controller;
[Area("Admin")]
    ...
    public class AccountsController : Microsoft.AspNetCore.Mvc.Controller
    {
        ...
        public AccountsController(NTL_BookDbContext context, UserManager<ApplicationUser> userManager)
        {
